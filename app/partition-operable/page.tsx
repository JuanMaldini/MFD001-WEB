      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
        ...
        <div className="grid grid-cols-1 gap-4">
          {options.map((opt) => (
            <div
              key={opt.id}
              className={`relative rounded-2xl border transition-all ${pocketType === opt.id
                ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.1)]'
                : 'bg-white/5 border-white/10 hover:border-white/20'
                }`}
            >
        ...
        <div className="grid grid-cols-1 gap-4">
          {options.map((opt) => (
            <button
              ...
              className={`text-left p-6 rounded-2xl border transition-all ${durability === opt.id
                ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.1)]'
                : 'bg-white/5 border-white/10 hover:border-white/20'
                }`}
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${durability === opt.id ? 'border-emerald-500 bg-emerald-500' : 'border-white/20'
                  }`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {stcOptions.map((val) => (
            <button
              key={val}
              onClick={() => setSTC(val)}
              className={`relative p-8 rounded-2xl border flex flex-col items-center justify-center gap-4 transition-all group ${stc === val
        ...
        <div className="grid grid-cols-1 gap-4">
          {options.map((opt) => (
            <button
              ...
              className={`text-left p-6 rounded-2xl border transition-all ${bottomSeal === opt.id
                ? 'bg-emerald-500/10 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.1)]'
                : 'bg-white/5 border-white/10 hover:border-white/20'
                }`}
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${bottomSeal === opt.id ? 'border-emerald-500 bg-emerald-500' : 'border-white/20'
                  }`}>
        ...
        <div className="grid grid-cols-1 gap-3">
          {options.map((opt) => (
            <button
              ...
              className={`text-left p-4 rounded-xl border transition-all flex items-center justify-between group ${finishType === opt.id
            ...
            >
              ...
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${finishType === opt.id ? 'border-emerald-500 bg-emerald-500' : 'border-white/20'
                }`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            {hingeOptions.map(opt => (
              <button
                ...
                className={`p-4 rounded-xl border text-left transition-all ${hingeType === opt.id
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {colorOptions.map(opt => (
              <button
                ...
                className={`p-3 rounded-xl border text-left transition-all flex items-center gap-3 ${trimColor === opt.id
                  ? 'bg-emerald-500/10 border-emerald-500'
                  : 'bg-white/5 border-white/10 hover:border-white/20'
                  }`}
              >
      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className={`w-full text-left p-6 rounded-2xl border transition-all flex items-start justify-between ${passdoor
              ? 'bg-emerald-500/10 border-emerald-500'
              : 'bg-white/5 border-white/10 hover:border-white/20'
              }`}
          >
            ...
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all mt-1 ${passdoor ? 'bg-emerald-500 text-black' : 'bg-white/10 text-transparent'
              }`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          {/* Worksurface */}
          <div className={`rounded-2xl border transition-all overflow-hidden ${workSurface
            ...
            >
              ...
              <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all mt-1 ${workSurface ? 'bg-emerald-500 text-black' : 'bg-white/10 text-transparent'
                }`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  <path fillRule="evenodd" d="M19.916 4.626a.75.75 0 01.208 1.04l-9 13.5a.75.75 0 01-1.154.114l-6-6a.75.75 0 011.06-1.06l5.353 5.353 8.493-12.739a.75.75 0 011.04-.208z" clipRule="evenodd" />
                </svg>
              ...
              <div className="px-6 pb-6 pt-2 animate-in slide-in-from-top-2 duration-300">
                <div className="grid grid-cols-2 gap-3 p-1 bg-black/40 rounded-xl">
                  <button
                    ...
                    className={`py-3 px-4 rounded-lg text-sm font-bold transition-all ${workSurfaceType === 'marker_board'
                  ...
                  <button
                    ...
                    className={`py-3 px-4 rounded-lg text-sm font-bold transition-all ${workSurfaceType === 'tack_board'
                      ? 'bg-emerald-500 text-black shadow-lg'
                      : 'text-slate-400 hover:text-white hover:bg-white/5'
                      }`}
                  >
                ...
                {[
                  ...
                  return (
                    <div key={step.id} className="flex items-center gap-2 shrink-0">
                      <div className={`w-6 h-6 rounded-md flex items-center justify-center text-[10px] font-black transition-all rotate-45 ${isActive ? 'bg-emerald-500 text-black shadow-[0_0_15px_rgba(16,185,129,0.4)]' :
